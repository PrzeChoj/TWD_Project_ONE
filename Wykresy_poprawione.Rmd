...
levels(World$Label) <- c(" Korea", " Japan", " Russian Federation", " Singapore", " Finland", " United Kingdom", " United States",  " Denmark", " China",
                         " Netherlands", " Israel", " Canada", " Germany", " Hong Kong", " Ireland", " Norway",
...
ggplot(Wynik, aes( x = factor(Wynik$CNT, levels(World$Label)), y = quantiles, colour = Label)) +
  ...
  #           color = "black", linetype = "dashed", alpha=0.27) +
  annotate("point", x = 6, y = 433.5613, colour = "#00247D", size=6) +
  annotate("point", x = 6, y = 497.4420, colour = "#CF142B", size=6) +
  annotate("point", x = 6, y = 558.7130, colour = "#f2c10d", size=6) +
  theme(legend.position = "bottom", 
        axis.text.y = element_text(size = c(rep(10, 5), 17, rep(10, 13), 14)),
        plot.title = element_text(hjust = 1),
        panel.background = element_rect("#DEE7EF"),
        plot.margin = margin(t = 0.3, r = 0.5, b = 0, l = 0.5, "cm")) +
  annotate("point", x = 20, y = 446.6301, colour = "#00247D", size=4) +
  annotate("point", x = 20, y = 506.9538, colour = "#CF142B", size=4) +
  annotate("point", x = 20, y = 565.3908, colour = "#f2c10d", size=4) +
...
ggplot(z, aes(x = sex, y = MEAN)) +
  ...
  geom_violin(aes(color = type), fill="transparent", alpha = 0.4, adjust = 0.7, draw_quantiles = c(0.2, 0.8), linetype = 2) +
